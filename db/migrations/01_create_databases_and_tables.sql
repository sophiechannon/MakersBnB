...
CREATE TABLE bookings(id SERIAL PRIMARY KEY, booker_id INTEGER REFERENCES users (id), booking_date DATE, booking_status VARCHAR(20), property_id INTEGER REFERENCES properties (id));